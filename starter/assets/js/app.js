...
function printtable(){
    ...
    for( let i=0;i<tasks.length;i++){
     ...
     document.getElementById("to-do-tasks").innerHTML+=`
     <button id="${tasks[i].id1}" class="task col-xxl-12 col-md-12 col-sm-12 btn-light text-black border-bottom border-end-0 text-start w-100" draggable="true" data-bs-toggle="modal" data-bs-target="#modal-task-update" onclick="showinput(this.id);">
	<div class="row">
